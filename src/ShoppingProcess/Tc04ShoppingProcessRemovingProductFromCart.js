...
async function Tc04ShoppingProcessRemovingProductFromCart() {
    ...
    if (errorMessageIsUserInRightPlace.match(/ Summary/)) {
        ...
        console.log("Tc04ShoppingProcessRemovingProductFromCart user is not in shopping cart summary");
    }
    ...
    if (errorMessageIsProductVisibleInCart.match(/1 Product/)) {
        ...
        console.log("Tc04ShoppingProcessRemovingProductFromCart there id different amount of products in shopping cart than expected");
    }
    ...
    if (pageUrl == 'http://automationpractice.com/index.php') {
        ...
        console.log('Error Tc04ShoppingProcessRemovingProductFromCart Main page address do not match to pattern');
    }
